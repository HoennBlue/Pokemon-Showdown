...
export class RandomSeasonalTeams extends RandomGen6Teams {
	randomTeam() {
		...
		for (let i = 0; i < 6; i++) {
			...
			const set = Object.assign({name, evs: {hp: 84, atk: 84, def: 84, spa: 84, spd: 84, spe: 84}, ivs: {}, level: 100, shiny: false}, sets[name]);
			set.ivs = Object.assign({hp: 31, atk: 31, def: 31, spa: 31, spd: 31, spe: 31}, set.ivs);
